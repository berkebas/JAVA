...
/*
 * button1.addActionListener(e -> { // butona tıklandığında çalışacak kod bloğu
 * String text = text1.getText(); // metin alanındaki yazıyı alır
 * label1.setText("Merhaba " + text); // etikete yeni metni ekler
 * });
 */